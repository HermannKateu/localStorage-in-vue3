...
describe("HolidayPage", () => {
  ...
  describe(
    "should sign-up the user to the home page",
    { keystrokeDelay: 50 },
    () => {
  ...
  describe(
    "should display an error message if the account already exist",
    { keystrokeDelay: 50 },
    () => {
  ...
  describe("should not sign-in the user", { keystrokeDelay: 50 }, () => {
    it(
      "when the password input is not filled and display and error message on login",
      { keystrokeDelay: 50 },
      () => {
    ...
    describe("HomePage", () => {
      ...
      describe("enters in the holidays page", () => {
        ...
        it("and does to the holiday form", () => {
          ...
          cy.get("[data-test='select-holiday']")
            .select("Martenite")
            .should("have.value", "Martenite");
          ...
          cy.get("[data-test='describe']").type(
            "Thanks for visiting our site and see you naschte mal......"
          );
        });
      });
    });
